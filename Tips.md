...
### LABZ
```bash
Run a solid -sC -sV nmap scan against the lab net and save the file so you don't have to keep scanning. Look at it and pick the easiest looking ones first. Aboout half of the boxes require something from other boxes or depend on pivioting. So don't just go 1-255.
My first 15 boxes were:
10.11.1.128	10.11.1.251
10.11.1.116	10.11.1.31
10.11.1.8	10.11.1.115
10.11.1.14	10.11.1.13
10.11.1.50	10.11.1.35
10.11.1.217	10.11.1.39
10.11.1.5	10.11.1.71
10.11.1.251	
```
### OFFSEC Forums 
```bash
It is full of riddles and people asking the same question you have but then updating with "NVM rooted" Hopefully our group can answer eachother's questions instead.
```
### Eternal Blue
```bash
